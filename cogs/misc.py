...
from templates import Bot, Cog, Interaction, Emoji
...
class MiscCog(Cog, name="miscellaneous"):
    ...
    async def ping_command(self, interaction: Interaction) -> None:
    ...
    async def flip_command(self, interaction: Interaction) -> None:
    ...
    async def urlshort_command(self, interaction: Interaction, url: str) -> None:
    ...
    async def avatar_command(self, interaction: Interaction, user: discord.User = None) -> None:
        if not user:
    ...
    async def server_command(self, interaction: Interaction) -> None:
